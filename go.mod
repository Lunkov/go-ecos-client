...
require (
	github.com/Lunkov/go-ecos-client/messages v0.0.0-20230903141945-7f01805e1bed
	github.com/Lunkov/go-ecos-client/objects v0.0.0-20230903141945-7f01805e1bed
