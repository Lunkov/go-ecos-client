...
replace go-ecos-client/messages => ./messages
...
require (
	...
	go-ecos-client/messages v0.0.0-00010101000000-000000000000
	go-ecos-client/objects v0.0.0-00010101000000-000000000000
)
