...
require (
	github.com/Lunkov/go-ecos-client/messages v0.0.0-20230608055654-0a88330522d9
	github.com/Lunkov/go-ecos-client/objects v0.0.0-20230608055654-0a88330522d9
