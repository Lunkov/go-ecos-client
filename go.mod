...
require (
	github.com/Lunkov/go-ecos-client/messages v0.0.0-20230613053142-63b2066fac39
	github.com/Lunkov/go-ecos-client/objects v0.0.0-20230613053142-63b2066fac39
