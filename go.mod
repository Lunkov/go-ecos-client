...
require (
	github.com/Lunkov/go-ecos-client/messages v0.0.0-20230824101215-9064e7d3192c
...
require (
	...
	github.com/Lunkov/go-ecos-client/utils v0.0.0-20230824084536-4755ab468703 // indirect
