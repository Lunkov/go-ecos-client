...
require (
	github.com/Lunkov/go-ecos-client/messages v0.0.0-20230528193409-f795e4a6159a
...
require (
	...
	github.com/Lunkov/go-ecos-client/utils v0.0.0-20230528193409-f795e4a6159a // indirect
